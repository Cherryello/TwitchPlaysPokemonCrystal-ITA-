...
BetBoyString:
	db   "Si é verificato"
	next " "
	next "un errore fatale," ; "un fatale errore"
	next " "
	next "MANNAGGIA A DIO!" ; "BET-BOY."
	next " "
	next "AF:       BC:"
	next "DE:       HL:"
	next "SP:     (        )"
	next " "
	next "Riavvia 'sto cazzo" ; "Riavvia il gioco"
	next " "
	next "di gioco di merda.@" ; "per continuare."
...
GBCOnlyString: ; 4eb38
	db   "Questo gioco é"
	next "compatibile solo"
	next "su Game Boy Color"
	next "e Advance.@"
; 4eb76
