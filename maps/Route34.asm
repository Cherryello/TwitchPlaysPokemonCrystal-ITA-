...
UnknownText_0x784f0: ; 0x784f0
	text "Forse dovrei"
	line "lasciarne uno alla"
	cont "pensione. O forse"

	para "dovrei usare"
	line "qualche strumento<...>"
	done
; 0x78532
...
UnknownText_0x785b8: ; 0x785b8
	text "Forse dovrei far"
	line "evolvere il mio"
	cont "Chikorita<...>"

	para "Ma é troppo cari-"
	line "no, non posso"
	cont "farlo evolvere<...>"
	done
; 0x785e4
...
UnknownText_0x786fc: ; 0x786fc
	...
	para "A quanto pare mi"
	line "piacciono i #-"
	cont "mon cucciolo!"

	para "Non c'é niente di"
	line "cui vergognarsi!"
	done
; 0x78743
