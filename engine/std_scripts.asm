...
ContestThirdPlaceText
	text $52, ", il ter-"
	line "zo classificato"
	cont "vince", $f0, "4000!"
	done

BagFullPrizeText:
	text "Dal momento che"
	line "non possiamo darti"
	cont "altro, tieni", $f0, "8000."
	done
...
FirstPlaceQuestion:
	text $52, ", il pri-"
	line "mo classificato"
	cont "vince una"
	cont "Pietrasolare!"

	para "Tuttavia puoi sce-"
	line "gliere un altro"
	cont "premio."
...
ContestAlreadyHolding
	...
	para "Devi prendere un"
	line "altro premio."
	done

BallsChosenText:
	text "Allora accetta"
	line "queste ball rica-"
	para "vate da delle"
	line "ghicocche."
	done
