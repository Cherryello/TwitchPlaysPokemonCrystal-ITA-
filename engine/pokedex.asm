...
String_40f32: ; 40f32
	db "Sto applicando", $4e, "le modifiche...@"
; 40f4f
...
.Unknown
	...
	db   "Nessuna info di-"
	next "sponibile per"
	next "questo Pokémon al"
	page "momento. Assicura-"
	next "ti che il Pokédex"
	next "sia aggiornato.@"
